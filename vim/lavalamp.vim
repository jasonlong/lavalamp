...
if &background == "dark"
  ...
  :let gray_xxx_high = '#fefeff'
  :let gray_xx_high  = '#f6f5f5'
  :let gray_x_high   = '#e8e4e4'
  :let gray_high     = '#d7cfcd'
  :let gray_med_high = '#c1b5b1'
  :let gray_med      = '#aa9591'
  :let gray_med_low  = '#8d7671'
  :let gray_low      = '#6a5a56'
  :let gray_x_low    = '#494240'
  :let gray_xx_low   = '#2b2b2c'
  :let gray_xxx_low  = '#1a1d1e'

  :let blue_x_high   = '#b5e6fe'
  :let blue_high     = '#75d9fd'
  :let blue_med      = '#24b9fc'
  :let blue_low      = '#137dc6'
  :let blue_x_low    = '#095583'
  ...
  :let red_x_high    = '#fdafa5'
  :let red_high      = '#fc574e'
  :let red_med       = '#fc2729'
  :let red_low       = '#eb0f19'
  :let red_x_low     = '#9e080d'
  ...
  :let green_high    = '#4afd4c'
  :let green_med     = '#23dd2d'
  :let green_low     = '#18a721'
  :let green_x_low   = '#0b6c14'
  ...
  :let gray_xxx_high = '#161717'
  :let gray_xx_high  = '#232120'
  :let gray_x_high   = '#383230'
  :let gray_high     = '#524440'
  :let gray_med_high = '#6a5751'
  :let gray_med      = '#876c65'
  :let gray_med_low  = '#a18781'
  :let gray_low      = '#b6a39e'
  :let gray_x_low    = '#ccbfbc'
  :let gray_xx_low   = '#e3ddde'
  :let gray_xxx_low  = '#f8f9ff'

  :let blue_x_high   = '#063f5a'
  :let blue_high     = '#0c5c94'
  :let blue_med      = '#1d8eef'
  :let blue_low      = '#59b1fc'
  :let blue_x_low    = '#95c3f5'
  ...
  :let red_x_high    = '#770608'
  :let red_high      = '#cf0c15'
  :let red_med       = '#fc2124'
  :let red_low       = '#fb433f'
  :let red_x_low     = '#fc8275'
  ...
  :let green_x_high  = '#07500f'
  :let green_high    = '#107918'
  :let green_med     = '#1cb424'
  :let green_low     = '#3ff341'
  :let green_x_low   = '#8efb72'
